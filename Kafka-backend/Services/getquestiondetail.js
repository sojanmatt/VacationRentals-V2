...
function handle_request(msg, callback) {
  var res = {};
  console.log(
    "In get specific question details request:" + JSON.stringify(msg)
  );
  ...
  var pipeline = [
    ...
    {
      $match: {
        "messages.prop_id": msg.messages.prop_id,
        "messages.travelername": msg.messages.username
      }
    },
  ...
  promise
    .then(function(data) {
      console.log("current messages for traveler data-");
      console.log(data);
      res.value = data;
      if (data) {
        res.code = 200;
