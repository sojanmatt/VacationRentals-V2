...
function handle_request(msg, callback) {
  var res = {};
  console.log("In Owner login handle request:" + JSON.stringify(msg));
  mongo.myconnect(mongoURL, function() {
    console.log("Connected to mongo at: " + mongoURL);
    var coll = mongo.collection("HomeAway");
    console.log("inside owner login mongo query");
    // key = "273";
    ...
    coll.findOne({ "user.username": msg.username }, function(err, user) {
      console.log("result owner login  is ", JSON.stringify(user));
